...
## Create the 3d plot -- LEARN MORE
# TV/Radio grid for 3d plot
xx1, xx2 = np.meshgrid(np.linspace(X.TV.min(), X.TV.max(), 100),
                       np.linspace(X.Radio.min(), X.Radio.max(), 100)) # Try with less space
...
# plot data points - points over the HP are white, point below are black
